  ...
  <div class="main--content">
    ...
    if ($result->num_rows > 0) {
      ...
      <button class="addBtn" data-modal-target='#printform'>
          <i class="fas fa-plus" id="plus"></i>Print
        </button>
                ...
                <div class="forms" id="form1">
                    ...
                    <div class="input-fields">
                        ...
                        <div class="input-fields">
                            ...
                            <input  type="text" name="section" placeholder="Enter your Course" required>
                        </div>
                        <div class="input-fields">
...
<div class="modal" id="viewrecord">
  <div class="modal-body" >
    <div class="viewcontainer"> <!-- Add the ID 'invoice-content' here -->
      ...
      <?php
      echo "<form id='viewform' action='userprint.php' method='post'>
      <input type='text' id='vunique_id' name='unique_id' oninput='checkInput(this)'>
      
      <button type='button' class='pdf-btn' onclick='downloadPDF()'>Download as PDF</button> <!-- Change to button instead of submit -->
      </form>";
      ?>
      <button class='printpdf-btn' onclick='printInvoice()'>Print Invoice</button>
        <!-- <button type='submit' class='pdf-btn' name='print'>Download PDF</button> -->
    </div>
    <div class="viewModal2">
...
<div style="z-index: 2; position: relative; margin-left: 700px;">
          <img id="vpicture" width="100px" alt="right Image">
          <span class="nav-header"></span>
</div>

<div class="info">
         <span  class="label" for="course">Course: </span>
         <span  class="label" id="vcourse"></span><br>
         <span  class="label" for="course"> Year Level: </span><span class="label" id="vyear"></span><br>
        <span  class="label" for="course"> Section: </span><span  class="label" id="vsection"></span><br>
         <span class="label" for="course">SY: 2024-2025</span>
</div>
                        ...
                        <table class="b">
                            <tbody>
                                <tr>
                                    ...
                                    <td><span id="vlname"></span><span>, </span><span id="vfname"></span><span> </span><span id="vmname"></span><span>. </span></td>
                                </tr>
                                <tr>
                                    <td><span class="label" for="religion">Religion:</span></td>
                                    <td><span id="vreligion">'.$row['religion'].'</span></td>
                                </tr>
                                <tr>
                                    <td><span class="label" for="DateOfBirth">Date of Birth:</span></td>
                                    <td><span id="vbday">'.$row['bday'].'</span></td>
                                </tr>
                                <tr>
                                    <td><span class="label" for="age">Age:</span></td>
                                    <td><span id="vage">'.$row['age'].'</span></td>
                                </tr>
                                <tr>
                                    <td><span class="label" for="gender">Gender:</span></td>
                                    <td><span id="vgender">'.$row['gender'].'</span></td>
                                </tr>
                                <tr>
                                    <td><span class="label" for="address">Home Address:</span></td>
                                    <td><span id="vaddress">'.$row['address'].'</span></td>
                                </tr>
                                <tr>
                                    <td><span class="label" for="parent">Parent / Guardian:</span></td>
                                    <td><span id="vguardian">'.$row['guardian'].'</span></td>
                                </tr>
                                <tr>
                                    <td><span class="label" for="contact">Emergency Contact:</span></td>
                                    <td><span id="vemergency">'.$row['emergency_no'].'</span></td>
                                </tr>            
                            </tbody>
                        </table>
                    </td>
            ...
            <table>
                ...
                <tr style="position: relative; top: -115px;">
    ...
    exit;
        ...
        echo "<script>Swal.fire('Error', 'Failed to register the user. Please try again.', 'error');</script>";
          ...
          try {
              ...
              $stmt1->bind_param("sssssssisssssi",$id_no, $lname, $fname, $mname, $gender, $religion, $bday,
              $age, $contact_no, $course, $address, $guardian,$emergency,  $unique_id);
              $stmt1->execute();
